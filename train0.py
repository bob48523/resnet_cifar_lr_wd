...
def main():
    ...
    #args.save = args.save or 'work/lr/lr0.1'
    ...
    trainLoader = DataLoader(
        dset.CIFAR100(root='/dataset/cifar', train=True, download=True,
                     transform=trainTransform),
        batch_size=args.batchSz, shuffle=True, **kwargs)
    valLoader = DataLoader(
        dset.CIFAR100(root='/dataset/cifar', train=False, download=True,
